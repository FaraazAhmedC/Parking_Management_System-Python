...
class HomeScreen(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CAHCET PARKING MANAGEMENT SOFTWARE")
        self.setWindowIcon(QIcon("parking logo.png"))
        self.resize(900, 900)
        self.dbOperation=DBOperation()
        widget=QWidget()
        widget.setStyleSheet("background:#C0C0C2")
        layout_horizontal=QHBoxLayout()
        menu_vertical_layout=QVBoxLayout()

        self.btn_home=QPushButton("Home")
        self.btn_add = QPushButton("Add a Vehicle")
        self.btn_manage = QPushButton("Manage a  Vehicle")
        self.btn_history = QPushButton("History")

        menu_vertical_layout.setContentsMargins(0,0,0,0)
        menu_vertical_layout.setSpacing(0)
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#3D3D3D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showHistory(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#3D3D3D;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showManage(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#3D3D3D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showAdd(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#3D3D3D;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#7E7E7E;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:#55a03c;color:white;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:#D10000;color:white;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addHomePageData(self):
        ...
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#002C56;border:0.5px solid black")
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:#55a03c;color:white;padding:5px;width:400px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:#D10000;color:white;padding:5px;width:400px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addAddStudentPage(self):
        ...
        name_label.setStyleSheet("color:#000;font-weight:bold;padding:8px 0px;font-size:20px")
        mobile_label=QLabel("Mobile : ")
        mobile_label.setStyleSheet("color:#000;font-weight:bold;padding:8px 0px;font-size:20px")
        vechicle_label=QLabel("Vehicle No : ")
        vechicle_label.setStyleSheet("color:#000;font-weight:bold;padding:8px 0px;font-size:20px")
        vechicle_type=QLabel("Vehicle Type : ")
        vechicle_type.setStyleSheet("color:#000;font-weight:bold;padding:8px 0px;font-size:20px")
        error_label=QLabel("")
        error_label.setStyleSheet("color:red;padding:8px 0px;font-size:20px")

        name_input=QLineEdit()
        name_input.setStyleSheet("color:#000;padding:8px 0px;font-size:20px")
        mobile_input=QLineEdit()
        mobile_input.setStyleSheet("color:#000;padding:8px 0px;font-size:20px")
        vehicle_input=QLineEdit()
        vehicle_input.setStyleSheet("color:#000;padding:8px 0px;font-size:20px")
        vtype=QComboBox()
        vtype.setStyleSheet("color:#000;padding:8px 0px;font-size:20px;border:1px solid white")
        vtype.addItem("2 Wheeler")
        vtype.addItem("4 Wheeler")

        button=QPushButton("Add Vehicle",self)
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#002C56;border:1px solid white")
    ...
    def addManagePage(self):
        ...
        self.table.setStyleSheet("background:#fff;color:#000;font-weight:bold;border:0.5px solid black")
        ...
        for smalldata in data:
            ...
            self.button_exit.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#002C56;border:1px solid white")
    ...
    def addHistoryPage(self):
        ...
        self.table1.setRowCount(len(data))
        self.table1.setStyleSheet("background:#fff;color:#000;font-weight:bold;;border:1px solid white")
        self.table1.setColumnCount(7)
